...
async def main():
    ...
    AZURE_OPEN_AI__CHAT_COMPLETION_DEPLOYMENT_NAME = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME")
    AZURE_OPEN_AI__ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT")
    AZURE_OPEN_AI__API_KEY = os.getenv("AZURE_OPENAI_API_KEY")
